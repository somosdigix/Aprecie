...
def preencher_valores(apps, schema_editor):
    ...
    Valor.objects.create(nome='Segurança', resumo='Criar ambiente livre e responsável', descricao='Queremos que as pessoas tenham liberdade para assumir riscos e desenvolver seu potencial|Valorizamos um espaço compreensivo e respeitoso para exposição de opiniões|stimulamos a atitude responsável em todas as situações|Atuamos na construção de ambiente saudável, que favorece a produtividade e a aprendizagem')
